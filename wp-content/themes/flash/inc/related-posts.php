				...
				<div class="tg-column-3">
					...
					<div class="wrapper">
						...
						<div class="entry-meta">
							...
							$byline      = ' By <a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a>';

							echo '<span class="entry-date">' . $posted_ons . '</span>';
