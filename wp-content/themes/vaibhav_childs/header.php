...
//$customer_country = 'ES';
 $customer_country = $WOOCS->storage->get_val('woocs_user_country');
	//echo"<pre>";
	//print_r($customer_country);
	
	//$country= IN;
	if($customer_country =='IN'){?>
	<link rel="stylesheet" href="wp-content/themes/vaibhav_childs/custom_in.css">
	<?php }else {?>
	<link rel="stylesheet" href="wp-content/themes/vaibhav_childs/custom_sing.css">
	<?php } ?>
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="header-bottom">
			<div class="tg-container">
				...
				<div class="get_startbutton"id="get_startbutton">
								<button class="gs_buttn">Get Started</button>
							</div>
